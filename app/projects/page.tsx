...
export default function Projects() {
    ...
    return (
        <main className="bg-white min-h-[80vh] w-full p-8 rounded-3xl items-center container mx-auto">
            ...
            <section className="grid lg:grid-cols-2 gap-12">
                {projects?.map((project: ProjectType, i: number) => {
                    return (
                        <div className="rounded-3xl text-neutral-800" key={i}>
                            ...
                            <div className="flex flex-wrap mb-4">
                                {project?.stacks?.map((stack, i) => {
                                    return (
                                        <div className="px-4 py-1 mr-2 flex items-center lg:mr-4 mb-2 lg:mb-0 font-bold text-sm lg:text-base font-mono text-neutral-800 border-2 border-neutral-800 rounded-xl" key={i}>
                                            <div className='mr-2'>
